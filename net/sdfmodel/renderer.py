...
class NeuSRenderer:
    ...
    def render(self, input, training, perturb_overwrite=-1, background_rgb=None, cos_anneal_ratio=0.0):

        intrinsics = input["intrinsics"]
        uv = input["uv"]
        pose = input["pose"]
        mask = input["object_mask"].squeeze()
        ...
        z_vals = torch.linspace(0.0, 1.0, self.n_samples)  # t
